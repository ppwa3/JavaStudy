...
public class E03CarMain {
	...
	public static void main(String[] args) {
		...
		/*
		//자동차 2 객체 생성 : 초기화 메서드를 호출하는 대신 멤버변수에
		직접 접근하여 인스턴스를 초기화한다. 이경우 인스턴스를 생성할
		때마다 동이한 코드를 작성해야 하므로 비효율적이다.
		...
		/*
		//자동차 3 객체 생성 : 매개변수가 있는 초기화 메서드를 사용해서
		...
		/*
		//자동차4 객체 생성 : 인스턴스 생성만 하고 초기화하지 않은 상태로
		  출력을 시도하므로 예외가 발생된다. */
		Car car4 = new Car();
		car4.showCarInfo();
	}
