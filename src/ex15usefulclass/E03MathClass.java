...
/*
Java의 규칙 : java.lang패키지 하위의 모든 클래스는 자동으로
	import된다. 또한 정의하는 모든 클래스는 object를 상속하게
	된다.
	따라서 java.lang패키지의 모든 클래스는 별도의 선언없이 사용할
...
public class E03MathClass extends Object {
	...
	public static void main(String[] args) {
		...
		System.out.println("Mate.abs:"+ Math.abs(d));
		System.out.println("Math.abs:"+ Math.ceil(num));
		...
		/*
		0~1사이의 실수를 랜덤하게 반환한다. 따라서 정수값을 만들도
		싶다면 특정한 값을 곱해주면된다.`*/
