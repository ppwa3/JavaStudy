...
class MyClass extends SimpleClass implements MyInterface1,
		MyInterface2 {
	/*
	...
	public void absFunc1() {
		System.out.printf("absFunc1() 호출됨");
	}
	/*
	simpleClass클래스의 멤버메서드는 오버라이딩이 필수가 아니므로
	필요한 경우에만 추가하면된다. */
	@Override
